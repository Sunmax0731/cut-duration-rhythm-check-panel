...
この repo は `cut-duration-rhythm-check-panel` の closed alpha 実装単位です。

## Scope

- Root: `D:\AI\WindowsApp\cut-duration-rhythm-check-panel`
- Domain: WindowsApp
- Product kind: windows-app
- Source pack: `D:/AI/WindowsApp/created_idea_014_cut-duration-rhythm-check-panel/idea_014_cut-duration-rhythm-check-panel.zip`
- Public repo: `https://github.com/Sunmax0731/cut-duration-rhythm-check-panel`

## Working Rules

- README、AGENTS、SKILL、docs を同じ変更単位で更新する。
- created_idea は `D:/AI/WindowsApp/created_idea_014_cut-duration-rhythm-check-panel` を正とし、同梱 ZIP の `metadata.json` と repo 名が一致することを確認する。
